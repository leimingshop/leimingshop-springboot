 ...
 * @Description:封装售后申请和对应的售后商品数据实体(一对多关系)
 * @Date: 2019/6/15 16:07
 * @Version: V1.0
 */
@Data
@ApiModel(description = "AftersaleApplyRecordDTO")
public class AftersaleApplyRecordDTO implements Serializable {
    ...
    @ApiModelProperty(value = "仲裁结果（1:审核通过、2:审核不通过、3:待审核）")
