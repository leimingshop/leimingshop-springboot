...
package com.leimingtech.modules.aftersale.enmus;
...
public enum AfterSaleStateEnum {
    ...
    //售后单状态4:确认收货
    AFTER_STATUS_RECEIVE_RETURNIN(4),
    //售后单状态5:退款中
    AFTER_STATUS_PAYING(5),
    //售后单状态6:退款成功
    AFTER_STATUS_PAYSUCESS(6),
    //售后单状态7:换货失败
    AFTER_STATUS_BARTERFAIL(7),
    //售后单状态8:待换货入库
    AFTER_STATUS_BARTERIN(8),
    //售后单状态9:换货出库中
    AFTER_STATUS_BARTEROUT(9),
    //售后单状态10:换货成功
    AFTER_STATUS_BARTERSUCESS(10),
    //售后物流状态1为买家待发货
