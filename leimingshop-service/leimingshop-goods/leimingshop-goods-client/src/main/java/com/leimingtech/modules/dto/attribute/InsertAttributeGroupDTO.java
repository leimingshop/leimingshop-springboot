 ...
 */
@Data
@ApiModel(description = "InsertAttributeGroupDTO")
public class InsertAttributeGroupDTO implements Serializable {
    private static final long serialVersionUID = 1L;

    @ApiModelProperty(value = "属性分组名称")
    @NotBlank(message = "属性名称不能为空", groups = AddGroup.class)
    @Size(max = 20, message = "属性分组名称长度不能超过20", groups = AddGroup.class)
