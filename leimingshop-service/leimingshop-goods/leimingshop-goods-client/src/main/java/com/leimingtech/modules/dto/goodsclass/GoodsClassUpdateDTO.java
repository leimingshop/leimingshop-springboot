 ...
 */
@Data
@ApiModel(description = "GoodsClassUpdateDTO")
public class GoodsClassUpdateDTO implements Serializable {
    ...
    private List<GoodsClassBrandSaveDTO> goodsClassBrandSaveDTO;
