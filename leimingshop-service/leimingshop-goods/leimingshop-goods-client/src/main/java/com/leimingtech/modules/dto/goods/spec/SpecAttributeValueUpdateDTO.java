 ...
 */
@Data
@ApiModel(description = "SpecAttributeValueUpdateDTO")
public class SpecAttributeValueUpdateDTO implements Serializable {
    ...
    private List<SpecAttributePictureDTO> specAttributePictureDTOList;
