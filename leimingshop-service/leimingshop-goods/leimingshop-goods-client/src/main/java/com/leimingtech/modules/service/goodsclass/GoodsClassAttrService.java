...
public interface GoodsClassAttrService {
    /**
     * 批量保存商品分类关联规格
     *
     * @param dto
    ...
    List<GoodsClassAttrDTO> list(@RequestParam Map<String, Object> params);
    ...
    void updateGoodsClassAttr(@RequestBody GoodsClassUpdateDTO dto);
    ...
    Integer findAttrByGcId(Long gcId);
}