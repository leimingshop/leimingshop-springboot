 ...
 **/
@Data
public class ConverterGoodsStatus implements Converter<Integer> {

    /**
     * 上架 1 ,下架0
     */
    public static final Integer GOODS_SHOW_ON = 1;
    public static final Integer GOODS_SHOW_DOWN = 0;
