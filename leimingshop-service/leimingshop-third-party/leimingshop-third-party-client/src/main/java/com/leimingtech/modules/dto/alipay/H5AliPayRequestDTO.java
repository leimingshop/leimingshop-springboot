...
public class H5AliPayRequestDTO implements Serializable {
    ...
    @ApiModelProperty("销售产品码，商家和支付宝签约的产品码。wap支付：QUICK_WAP_WAY; app支付：QUICK_MSECURITY_PAY")
