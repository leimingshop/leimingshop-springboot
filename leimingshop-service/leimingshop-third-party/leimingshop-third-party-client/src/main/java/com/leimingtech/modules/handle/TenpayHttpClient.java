...
import com.leimingtech.modules.util.HttpClientUtil;
...
public class TenpayHttpClient {
    ...
    public String callHttpsGet(String url) {
    ...
    /*public boolean callHttpsGet(String url) {
        boolean flag = false;
        try {
            SSLContext sc = SSLContext.getInstance("SSL");
            this.httpsGetMethod(url, sc);
            flag = true;
        } catch (IOException e1) {
            e1.printStackTrace();
