...
public class CartDTO implements Serializable {
    ...
    @ApiModelProperty(value = "商品所在二级店铺分类")
    ...
    @ApiModelProperty(value = "活动类型 0无活动 1优惠券 2满减 3 秒杀 4拼团 5限时购")
    ...
    @ApiModelProperty(value = "是否有优惠券  1 是 0 否")
    private Integer couponsFlag;
    @ApiModelProperty(value = "当前商品可用优惠券")
    private GoodsDetailCouponsListDTO goodsDetailCouponsListDTO;
    @ApiModelProperty(value = "当前商品可用满减活动")
    private List<FrontReduceActivityPageDTO> frontReduceActivityPageDTO;
