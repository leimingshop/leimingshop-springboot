...
@Data
@ApiModel(value = "提现详情")
public class WithdrawalDetailDTO implements Serializable {
    ...
    @ApiModelProperty(value = "申请时间线集合")
    private List<WithdrawalApplicationLogDTO> withdrawalApplicationLogDTOList;
