 ...
 **/
@Data
@ApiModel(description = "PcOrderDetailVO")
public class PcOrderDetailVO implements Serializable {
    ...
    private Map<String, List<LogisticsProcessDTO>> logisticsMap;

    @ApiModelProperty(value = "订单物流信息记录集合")
    private OrderLogisticsDTO orderLogisticsDTO;

    @ApiModelProperty(value = "订单操作时间线集合")
