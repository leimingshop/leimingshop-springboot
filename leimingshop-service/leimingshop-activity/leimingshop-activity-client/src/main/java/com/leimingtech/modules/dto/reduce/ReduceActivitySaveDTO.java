 ...
 */
@Data
@ApiModel(description = "ReduceActivitySaveDTO")
public class ReduceActivitySaveDTO implements Serializable {
    private static final long serialVersionUID = 1L;

    @ApiModelProperty(value = "满减活动名称")
    @Length(max = 20, message = "满减活动名称不可超过20个字", groups = AddGroup.class)
    @NotBlank(message = "满减活动名称不能为空", groups = AddGroup.class)
    ...
    @NotNull(message = "活动规则不能为空", groups = AddGroup.class)
    ...
    @NotEmpty(message = "活动规则不能为空", groups = AddGroup.class)
    @Size(max = 6, message = "阶梯满减规则数量不能超过6条", groups = AddGroup.class)
