 ...
 */
@Data
@ApiModel(value = "新增店铺秒杀活动实体")
public class InsertStoreSeckillActivityDTO implements Serializable {
    private static final long serialVersionUID = 1L;

    @ApiModelProperty(value = "场次id")
    @NotNull(message = "秒杀时间不能为空", groups = AddGroup.class)
    ...
    @NotNull(message = "秒杀活动有效期不能为空", groups = AddGroup.class)
    @Min(value = 1, message = "秒杀活动有效期不小于1小时", groups = AddGroup.class)
    @Max(value = 48, message = "秒杀活动有效期不大于48小时", groups = AddGroup.class)
    ...
    @Max(value = 9999999, message = "活动限购数量最大值为9999999", groups = AddGroup.class)
