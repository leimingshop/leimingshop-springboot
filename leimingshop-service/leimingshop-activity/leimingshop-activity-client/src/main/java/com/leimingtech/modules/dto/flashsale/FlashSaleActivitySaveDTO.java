...
public class FlashSaleActivitySaveDTO implements Serializable {
    ...
    @NotNull(message = "订单支付有效时间不能为空", groups = AddGroup.class)
    @Min(value = 1, message = "订单支付有效时间不能小于1分钟", groups = AddGroup.class)
    @Max(value = 1440, message = "订单支付有效时间不能大于1440分钟", groups = AddGroup.class)
