...
public class AdvController {
    ...
    public Result<PageData<AdvDTO>> page(@ApiIgnore @RequestParam Map<String, Object> params, @ApiIgnore SellerDetail sellerDetail) {
    ...
    @ApiOperation("广告保存")
    @LogOperation("广告保存")
    public Result save(@RequestBody InsertAdvDTO dto, @ApiIgnore SellerDetail sellerDetail) {
        //效验数据
        ValidatorUtils.validateEntity(dto, AddGroup.class, DefaultGroup.class);
        AdvDTO advDTO = ConvertUtils.sourceToTarget(dto, AdvDTO.class);
        advDTO.setStoreId(sellerDetail.getStoreId());
        if (getAdvDTO(advDTO)) {
            // 广告开始开始时间晚于结束时间
    ...
    public Result saveSpecialAdv(@RequestBody InsertSpecialAdvDTO dto, @ApiIgnore SellerDetail sellerDetail) {
        //效验数据
        ValidatorUtils.validateEntity(dto, AddGroup.class, DefaultGroup.class);
        AdvDTO advDTO = ConvertUtils.sourceToTarget(dto, AdvDTO.class);
        advDTO.setStoreId(sellerDetail.getStoreId());
    ...
    @ApiOperation("广告修改")
    @LogOperation("广告修改")
    public Result update(@RequestBody UpdateAdvDTO dto, @ApiIgnore SellerDetail sellerDetail) {
        //效验数据
