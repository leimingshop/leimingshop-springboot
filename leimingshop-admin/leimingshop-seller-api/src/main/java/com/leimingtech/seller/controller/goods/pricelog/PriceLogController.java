...
package com.leimingtech.seller.controller.goods.pricelog;
...
import com.leimingtech.seller.excel.price.PriceLogExcel;
...
public class PriceLogController {
    ...
    public Result<PageData<PriceLogDTO>> page(@ApiIgnore @RequestParam Map<String, Object> params, SellerDetail sellerDetail) {
        // 获取店铺ID
        if (sellerDetail == null || sellerDetail.getStoreId() == null) {
            return new Result<PageData<PriceLogDTO>>().error(ErrorCode.UNAUTHORIZED, "用户未登录");
        }
