...
package com.leimingtech.admin.controller.stock;

import com.leimingtech.admin.excel.stock.StockLogExcel;
...
public class StockLogController {
    ...
    public Result<PageData<StockLogDTO>> page(@ApiIgnore @RequestParam Map<String, Object> params) {
