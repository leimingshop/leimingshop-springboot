...
package com.leimingtech.admin.controller.navigation;
...
public class NavigationController {
    ...
    public Result<PageData<NavigationDTO>> page(@ApiIgnore @RequestParam Map<String, Object> params) {
    ...
    @PostMapping
    @ApiOperation("保存")
    public Result save(@RequestBody AddNavigationDTO dto) {
        //效验数据
