...
import com.leimingtech.admin.excel.aftersale.AftersaleAuditExcel;
...
public class AftersaleAuditController {
    ...
    public Result<PageData<AftersaleAuditLogPageDTO>> page(@ApiIgnore @RequestParam Map<String, Object> params) {
        PageData<AftersaleAuditLogPageDTO> page = aftersaleAuditLogService.pageData(params, null);
    ...
    @ApiOperation("售后审核详情")
    public Result<AftersaleAuditDetailDTO> detail(@PathVariable("id") Long id) {
