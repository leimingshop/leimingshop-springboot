<template>
	<div class="crop-img">
		<div @click="showImgLib" :style="{width:imgWidth,height:imgHeight}" class="upload-box" >
			<img :src="cropImg | filterImgUrl"  :style="{width:'100%',height:'100%'}" v-if="cropImg" />
		...
		>
			<div style="width:100%;text-align: center;">
				<img :src="cropImg | filterImgUrl" alt="" style="max-width:100%"  >
			</div>
		</el-dialog>
...
export default {
    ...
    methods:{
		...
		showImgLib(){
			...
			this.$nextTick(()=>{
				this.$refs.picturesLibCompon.init(this.type);
			})
		},
