<template>
    ...
    <div>
        ...
        >
            ...
            <el-table-column prop="orderAmount" label="订单类型" align="center">
                <template slot-scope="scope">{{
                    scope.row.virtualFlag == 1 ? "虚拟订单" : "实体订单"
                }}</template>
            </el-table-column>
            <el-table-column
                prop="orderStatus"
            ...
            <el-table-column label="操作" width="220" align="center">
                <div slot-scope="scope" style="display: inline-flex">
                    <el-button
                        ...
                        v-if="
                            (scope.row.groupRecordId == undefined
    ...
    export default {
            ...
            return {
                ...
                orderState: function (row, column) {
                    return row.orderStatus == 0 ? (
                      ...
                      (row.groupStatus == 1 || row.groupRecordId == undefined) ? (
        ...
        methods: {
            ...
            accountInput(val) {
                ...
                this.goodsform.transportCode = str;
            },
            //确定发货
            goodsLog() {
