<template>
    <div>
        ...
        <el-form-item label="商品规格：" >
            <!-- 遍历一级 -->
            <div @ v-for="(item,index) in specLevel_1" style="margin-bottom:28px;margin-right: 10%" class="firstColor">
            ...
            <el-form-item label="商品设置："  style="margin-bottom:0">
               <goodsTableData style="margin-right: 10%" :dataForm="dataForm" :choosedSpecLevel_1="choosedSpecLevel_1"  :choosedSpecLevel_2="choosedSpecLevel_2"></goodsTableData>
            </el-form-item>

            <!-- <h4 style="padding-left: 50px;margin-top: 20px;">上传图片：</h4> -->
             <h3 style="margin-top: 30px;"  class="section">上传图片：</h3>
        ...
        console.log(specLevel_2);
          ...
          function getArguObj(item1,item2,item3){
              ...
              var obj =  {
                    ...
                    "specCostPrice":that.dataForm.specCostPrice,//商品成本价
                    "specMainPicture":"",
                    "specName":that.dataForm.goodsName+" "+nameConcat,//商品规格名称 ,//"手机 红",
                    "specName1":name1,
                    "specSellPrice":that.dataForm.specSellPrice,//商品售价
              ...
              that.goodsSpecSaveDTOList.forEach((item2,index2)=>{
                console.log("检测商品主图");
                  ...
                  if(item.img_use_id == item2.img_use_id){
                    item.specWeight = item2.specWeight;
     ...
     console.log(that.goodsSpecSaveDTOList);
      ...
      joinSpecAttributeRelationSaveDTOList(specLevel_1,specLevel_2){
          ...
          that.goodsSpecSaveDTOList.forEach((item,index)=>{
              ...
              specLevel_1.forEach((item2,index2)=>{
      ...
      setImgList(imgList){
          this.$emit("setImgList",imgList);
      },
      setSpecImgList(specImgList){
          console.log("115555888")
          console.log(specImgList)
        this.$emit("setSpecImgList",specImgList)
      },
      setSpecLevel_1(){
          this.$emit("setSpecLevel_1",this.specLevel_1)
      },

      setSpecLevel_2(){
          this.$emit("setSpecLevel_2",this.specLevel_2)
      }
