<template>
    <div>
        <div id="control-area">
            ...
            /></el-button>
            <el-button
                style="right: 220px; top: 12px; position: absolute"
                class="btn"
            ...
            >
                <template slot="title">
                    ...
                    <div class="iconSize">
                        2、商品列表的商品数据均为审核通过的商品（自营店铺无需审核）
                    </div>
                    <div class="iconSize">3、未上架和下架商品不能正常出售</div>
                    <div class="iconSize">
                        4、点击操作SKU可单独维护指定规格商品的名称、售价、成本价、库存
                    </div>
                </template>
            </el-alert>
        </div>
        ...
        >
                        ...
                        <div class="goodsProps">
                            <span class="goodsName">
                                ...
                                <el-tooltip
                                    ...
                                    placement="top-start"
                                >
                                    <!-- <a class="goodsNameContent" :href="scope.row | filterhrefUrl"  target="view_window">{{scope.row.goodsName}}</a> -->
                                    <span
                            ...
                            <span class="goodsBrand" v-if="scope.row.brandName">
            ...
            >
                <template slot-scope="scope">
                    <el-tag type="info" v-if="scope.row.goodsShow == 2"
                        >未上架</el-tag
                    >
            ...
            <el-table-column label="操作" align="center">
                <template slot-scope="scope">
                    ...
                    <el-button
                        ...
                        size="mini"
                        v-if="
                            dataForm.goodsStatus != 60 &&
                            $hasPermission('sys:goods:status')
                        "
                    >
                        <span
                            v-if="
                    ...
                    <el-button
                        ...
                        v-if="
                            dataForm.goodsStatus != 60 &&
                            $hasPermission('sys:goods:sku:view')
                        "
                        >SKU</el-button
                    >
                    <el-button
...
<script>
    ...
    import { goodsImport } from "@/api/io";
    ...
    import { brandListPull, addpicturecategory } from "@/api/api.js";
    ...
    import { goodsExcelTemplateExport } from "@/api/io";
        ...
        methods: {
            ...
            beforeUpload(file) {
                ...
                let params = qs.stringify({
                    token: Cookies.get("SELLER-TOKEN"),
                    modelId: id,
                });
                fd.append("file", file); //传文件
                fd.append("params", params); //传其他参数
                this.$http.post(goodsImport, fd).then(({ data: res }) => {
                    console.log(res);
                    if (res.code == 200) {
                        that.$message({
                            message: "成功导入" + res.data.goodsSum + "条",
                            type: "success",
                            duration: 1000,
                        });
                    } else {
            ...
            exportExcelTemplate() {
                ...
                window.location.href = `${goodsExcelTemplateExport}?${params}`;
            },
            // 获取品牌下拉列表
            ...
            previewH5Fn(row) {
                ...
                // this.$nextTick(()=>{
                //     this.$refs.previewH5Compon.init(row)
                // })
            },
            reset() {
                this.gcIds = "";
