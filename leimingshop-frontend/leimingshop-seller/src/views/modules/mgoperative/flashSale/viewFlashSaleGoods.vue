    ...
    <div class="seckill">
        ...
        <div class="addButton" v-if="row.activityState == 0">
            <el-button class="btn" type="primary"  @click="changeCompent(5)"
                       v-if="$hasPermission('sys:seckill:edit')">添加限时抢购商品
            </el-button>
        </div>
        ...
        >
            ...
            <el-table-column prop="activityPrice" label="限时抢购价" align="center" min-width="80">
                <template slot-scope="scope">
            ...
            <el-table-column prop="spuOrderNum" label="限时抢购订单" align="center" min-width="80"></el-table-column>
            <el-table-column label="操作" min-width="150" align="center" v-if="row.activityState != 2">
                <template slot-scope="scope">
                    ...
                    <el-button size="mini" type="text"
                               ...
                               @click="deleteActivityGoods(scope.row.goodsId)">移除
                    </el-button>
                </template>
            </el-table-column>
        </el-table>
...
<script>
    ...
    import {seckillGoodsPage, deleteFlashSaleGoods, seckillGoodsSkuDetail} from '@/api/api'
        ...
        methods: {
            ...
            deleteActivityGoods(goodsId) {
                this.$confirm('您确认移除该限时抢购商品吗?', '提示', {
                    ...
                    deleteFlashSaleGoods(obj).then((res => {
                        if (res.code == 200) {
                            this.$message({
                                message: res.msg,
                                type: 'success',
