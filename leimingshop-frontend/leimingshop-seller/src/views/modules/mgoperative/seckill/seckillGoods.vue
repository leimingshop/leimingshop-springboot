<template>
    ...
    <div class="seckill">
        ...
        <div class="table-box" v-show="showTable == 0">
            <seckillAddGoods ref="firstSkuList"></seckillAddGoods>
        </div>
        <!--已添加商品表格-->
        <div class="table-box" v-show="showTable == 1">
            <seckillAddedGoods ref="secSkuList"></seckillAddedGoods>
        </div>
...
<script>
    ...
    import seckillAddedGoods from "./seckillAddedGoods";
    import seckillAddGoods from "./seckillAddGoods";
