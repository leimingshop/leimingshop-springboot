<template>
    <div>
        ...
        <el-input v-model="dataForm.goodsName" placeholder="商品ID/名称" clearable></el-input>
                    ...
                    <el-form-item label="申请状态：" prop="auditResult">
                        <el-select
                ...
                <!--<el-radio-group v-model="dataForm.auditResult" @change="agreeChange">-->
                ...
                <el-table-column label="操作" align="center">
                    <template slot-scope="scope">
                        <el-button
                            ...
                            v-if="$hasPermission('sys:aftersale:apply:view')"
                            >查看详情</el-button
                        >
                        <!--<el-button-->
                        <!--size="mini"-->
...
<script>
    ...
    export default {
            ...
            return {
                ...
                sellerState: function (row, column) {
                    return row.auditStatus == 1 ? (
                        <el-tag type="warning">商家审核中</el-tag>
                    ) : row.auditStatus == 2 ? (
                        <el-tag type="warning">平台审核中</el-tag>
                    ) : row.auditStatus == 3 ? (
        ...
        components: { Bread, afterDet, modelPreviewH5 },
        watch: {
        ...
        methods: {
            ...
            getData() {
                ...
                this.dataForm.auditStartTime = this.auditTimeArr[0];
                this.dataForm.auditEndTime = this.auditTimeArr[1];
                this.page = 1;
                this.limit = 10;
                this.getDataList();
            }, // 预览h5
                ...
                if (index.aftersaleType == 0) {
                    ...
                    exchDetail(obj).then((res) => {
                        if (res.code == 200) {
                            ...
                            this.aftersale = res.data.aftersaleApplyDTO;
                            this.saleGoods = res.data.aftersaleGoodsDTOList;
                            this.infor = res.data.aftersaleBarterDTO;
                            res.data.aftersaleAuditLogDTOList.forEach(
                                (item, index) => {
                                    if (item.process == 1) {
                                        this.saleAuditLog = item; //商家审核数据
