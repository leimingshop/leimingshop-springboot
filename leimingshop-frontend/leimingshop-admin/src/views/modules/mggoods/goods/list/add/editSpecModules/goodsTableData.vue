    ...
    <div style="margin-right: 120px">
        ...
        >
            ...
            <el-table-column
                prop="specAttrName"
                :label="
                    this.choosedSpecLevel_1.length > 0 &&
                    this.choosedSpecLevel_1[0].name !== ''
                        ? this.choosedSpecLevel_1[0].name
                        : '主规格'
                "
                align="center"
            ...
            <el-table-column
                ...
                :label="
                    this.choosedSpecLevel_1.length > 0 &&
                    this.choosedSpecLevel_1[1].name !== ''
                        ? this.choosedSpecLevel_1[1].name
                        : '规格值'
                "
                align="center"
            ...
            <el-table-column
                ...
                :label="
                    this.choosedSpecLevel_1.length > 0 &&
                    this.choosedSpecLevel_1[2].name !== ''
                        ? this.choosedSpecLevel_1[2].name
                        : '规格值'
                "
                align="center"
        ...
        >
            <el-button @click="batch()" type="primary" size="mini"
                >批量设置</el-button
            >
        </div>
...
<style lang="scss" scoped>
    /deep/.specSerialInputClass .el-input__inner {
