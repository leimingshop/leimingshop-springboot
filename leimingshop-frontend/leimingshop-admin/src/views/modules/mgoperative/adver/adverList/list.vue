    ...
    <div>
            ...
            >
                ...
                <el-form-item label="广告类型：">
                    <el-select v-model="dataForm.advKey" placeholder="请选择">
                        ...
                        <el-option key="2" label="pc广告" value="pcIndex">
                        </el-option>

                        <el-option key="1" label="h5广告" value="h5index">
                        </el-option>
                        <el-option key="3" label="app启动页" value="appIndex">
                        </el-option>
                    </el-select>
                </el-form-item>
        ...
        >
            ...
            <el-table-column prop="advKey" align="center" label="广告类型">
                <template slot-scope="scope">
                    <span v-if="scope.row.advKey == 'h5index'">H5广告</span>
                    <span v-if="scope.row.advKey == 'pcIndex'">PC广告</span>
                    <span v-if="scope.row.advKey == 'appIndex'">app启动页</span>
                </template>
            </el-table-column>
