<template>
    <div>
                        ...
                        <div class="artbtn">
                            ...
                            >
                                <el-button
                                    ...
                                    type="primary"
                                    @click="actAddImgsBtn"
                                    v-if="$hasPermission('sys:picture:save')"
                                    >上传图片</el-button
                                >
                            </el-upload>
                            <el-button
                                ...
                                type="danger"
                                plain
                                @click="artDeletePicture"
                                v-if="$hasPermission('sys:picture:delete')"
                                >删除所选图片</el-button
                            >
                        </div>
                    </div>
        ...
        <el-dialog title="已选择的图片" :visible.sync="isshow">
            <img v-for="item in imgBase64Array" :src="item" alt="" />
            <el-button
                class="artuploadbtn"
                size="small"
                type="primary"
    ...
    export default {
        ...
        methods: {
            ...
            uploadpics() {
                ...
                let that = this;
                this.$http
                    .post(uploadPicBase64 + `?id=${iddata}&type=1`, this.imgurl)
                    .then(({ data: data }) => {
                        console.log(data);
