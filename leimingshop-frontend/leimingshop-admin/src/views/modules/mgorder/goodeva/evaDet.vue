    ...
    <div>
        ...
        <div class="evaBox">
            ...
            <div class="goods">
                ...
                <div class="goodsName">
                    <p>
                      <span style="color: #4e80db;text-decoration: none; cursor: pointer;" @click="previewH5Fn(evaDetails)" >
                            {{evaDetails.goodsName }}
                      </span>
                    </p>
                    <p>型号:{{evaDetails.goodsSpecId}}</p>
                </div>
            </div>
            <div class="evalist">
                <p class="word">评价</p>
                ...
                <div class="picList">
                    <span v-if="evaDetails.evaluateImage">
                      <img class="picEvaSize"
                                          :src="$imgDomain+item"
                                          alt=""
