    ...
    <div v-if="isChange">
        <div id="control-area">
            ...
            >
                ...
                <el-form-item label="申请类型：" prop="aftersaleType">
                    <el-select
            ...
            >
                <template slot="title">
                    ...
                    <div class="iconSize">
                        1、该页面仅展示需要平台该用户进行售后审核的数据
                    </div>
                    <div class="iconSize">
                        2、若售后单不需要进行平台审核，则不会展示在该列表中
                    </div>
                </template>
            </el-alert>
        </div>
        ...
        >
            ...
            >
                <template slot-scope="scope">
                    ...
                    <span
                        class="warningClass"
                        v-else-if="scope.row.aftersaleType == 1"
                        >换货</span
                    >
                    <span class="infoClass" v-if="scope.row.aftersaleType == 2"
                        >仅退款</span
                    >
                </template>
            </el-table-column>
            <el-table-column label="操作" min-width="150" align="center">
                <template slot-scope="scope">
                    <el-button
                        ...
                        v-if="$hasPermission('sys:aftersaleaudit:view')"
                        >查看详情</el-button
                    >
                    <el-button
                        size="mini"
                        ...
                        v-if="
                            scope.row.result == 3 &&
                            $hasPermission('sys:aftersaleaudit:apply')
                        "
        ...
        methods: {
            ...
            detShowChange(index, status) {
                ...
                if (index.auditStatus == 2) {
                    ...
                    this.isLog = false; //物流
                    this.detdata = ["订单管理", "售后管理", "售后审核", "审核申请"];
                    this.isChange = false;
                    ...
                    this.isAdminFin = false; //平台审核
                    this.isLog = false; //物流
                    this.detdata = ["订单管理", "售后管理", "售后审核", "售后详情"];
                    this.isChange = false;
                    this.getSalesDet(index);
                } else {
                    ...
                    this.detdata = ["订单管理", "售后管理", "售后审核", "售后详情"];
                    this.isLog = index.result == 1 ? true : false; //物流-审核通过
                    this.isChange = false;
                    this.getSalesDet(index);
                }
            },
