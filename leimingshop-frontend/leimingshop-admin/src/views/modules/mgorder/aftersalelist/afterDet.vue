<template>
    <div  class="aftersalelist_afterDetClass">
        <div v-if="isSaleList">
            <Bread :breaddata="detdata" @changePage="changePage" :index="index?index:'2'"></Bread>
            <!-- 分割线------------------------------------------------ -->
            ...
            <!-- 分割线------------------------------------------------ -->
            <div class="opctionItem" v-if="isSellerFin">
            ...
            <!--</div>-->
            <!--</div>-->
            <div class="opctionItem" v-if="isAdminFin">
            ...
            <!--&lt;!&ndash; status=3 && result=1 &ndash;&gt;-->
            <!--<p>{{isSelect==0?'退':'换'}}货物流</p>-->
            <!--<div>-->
            <!--<span class="inforTit">{{isSelect==0?'退':'换'}}货时间</span>-->
            <!--<span class="inforRight">{{barinfor.createDate}}</span>-->
            <!--</div>-->
            <!--<div>-->
            <!--<span class="inforTit">{{isSelect==0?'退':'换'}}货物流</span>-->
            <!--<span class="inforRight">{{barinfor.logisticsCompany}}</span>-->
            <!--</div>-->
            <!--<div>-->
            <!--<span class="inforTit">{{isSelect==0?'退':'换'}}货单号</span>-->
            <!--<span class="inforRight">{{barinfor.aftersaleSn}}</span>-->
            <!--</div>-->
            <!--</div>-->
            <div class="opctionItem" v-if="isLog && isSelect==0">
            ...
            <div class="opctionItem"  v-if="isLog && isSelect==1">
                <h3 style="font-size:20px">换货物流</h3>
                <el-form
                        class="saleOrderInfo"
                >
                    <div class="formWarp formWarp1">
            ...
            <div class="returnGoods">
                <div class="returnGoodsTop">
                    <h3 style="font-size:20px">{{isSelect==0?'退':'换'}}货商品</h3>
            ...
            <!-- 分割线------------------------------------------------ -->
            <h3 style="font-size:18px" v-if="isBtn">平台退换货处理</h3>
