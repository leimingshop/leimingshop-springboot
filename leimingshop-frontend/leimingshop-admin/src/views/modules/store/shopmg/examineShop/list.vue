<template>
    <div>
        ...
        >
            ...
            <el-table-column
                label="审核状态"
                prop="infoAuditStatus"
                align="center"
            >
                <template slot-scope="scope">
                    <el-tag
                        type="warning"
                        v-if="scope.row.infoAuditStatus == 10"
                        >待审核</el-tag
                    >
                    <el-tag
                        type="success"
                        v-if="scope.row.infoAuditStatus == 20"
                        >审核通过</el-tag
                    >
                    <el-tag
                        type="warning"
                        v-if="scope.row.infoAuditStatus == 30"
                        >审核拒绝</el-tag
                    >
                    <el-tag
                        type="warning"
                        v-if="scope.row.infoAuditStatus == 40"
                        >待提交</el-tag
                    >
                </template>
            </el-table-column>
            ...
            <el-table-column label="操作" align="center">
                <template slot-scope="scope">
                    <el-button
                        ...
                        v-if="
                            scope.row.infoAuditStatus == 10 &&
                            $hasPermission('sys:store:audit:status')
                        "
                        >审核</el-button
                    >
                    <el-button
                        ...
                        v-if="$hasPermission('sys:store:audit:view')"
                        >查看</el-button
                    >
                    <el-button
                        type="text"
                        ...
                        v-if="$hasPermission('sys:store:audit:tally')"
                        >操作流水</el-button
                    >
                </template>
            </el-table-column>
...
<script>
    ...
    import { auditBasicPgaeUrl } from "@/api/url";
    export default {
        mixins: [mixinViewModule],
        data() {
            return {
                mixinViewModuleOptions: {
                    getDataListURL: auditBasicPgaeUrl,
