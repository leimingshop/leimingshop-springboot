  ...
  <el-dialog :visible.sync="visible" :title="!dataForm.id ? $t('add') : $t('update')" :close-on-click-modal="false" :close-on-press-escape="false" class="rolePage">
    <el-form :model="dataForm" :rules="dataRule" ref="dataForm" @keyup.enter.native="dataFormSubmitHandle()" label-width="120px">
      <el-form-item prop="name" label="角色名称：">
        <el-input v-model="dataForm.name" :placeholder="$t('role.name')" maxlength="30"></el-input>
      </el-form-item>
      <el-form-item prop="remark" label="角色说明：">
        <el-input v-model="dataForm.remark" :placeholder="$t('role.remark')" maxlength="50"></el-input>
      </el-form-item>
      <el-row>
        <el-col :span="12">
