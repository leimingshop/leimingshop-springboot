                    ...
                    <div class="artp">
                        ...
                        <div class="Threelevelnav-left-con">
                            ...
                            <div class="Threelevelnav-left-con-r" >
                                    <div  v-if="level1.advDTO">
                                        <img
                                                v-for="(itemAdv, indexAdv) in level1.advDTO.advLinkConfigDTOList"
                                                :key="indexAdv"
...
<script>
    ...
    // import "swiper/css/swiper.css"; ssr注释
    ...
    export default {
        ...
        methods: {
            ...
            actCarousel(index) {
                    console.log("777777777777777777",this.IndexCustomClassData)
                    if(this.IndexAdvInPage[index].relationTarget &&this.IndexAdvInPage[index].relationType){
                            ...
                            }else if(this.IndexAdvInPage[index].relationType=='searchGoodsByClass'){
                                var id = this.IndexAdvInPage[index].relationTarget
                            ...
                            }else if(this.IndexAdvInPage[index].relationType=='topic'){
                                var id = this.IndexAdvInPage[index].relationTarget
                                let newpage = this.$router.resolve({
                                        path: "/subject",
                                        query: {
            ...
            getIndexNav() {
                IndexNav("")
                    .then((res) => {
                        if (res.code == 200) {
                            console.log('IndexNavList',res.data);
            ...
            goNavPage(item) {
                console.log(item);
                if (item.relationType == 1 && item.isOpen == 1) {
                    //新窗口打开链接
                    window.open(item.relationParams, "_blank");
                } else if (item.relationType == 2 && item.isOpen == 1) {
                    //新窗口打开商品分类页
                ...
                } else if (item.relationType == 1 && item.isOpen !== 1) {
                    //新窗口打开链接
