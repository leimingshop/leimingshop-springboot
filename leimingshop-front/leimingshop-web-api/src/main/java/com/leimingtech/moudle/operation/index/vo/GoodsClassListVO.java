 ...
 */
@Data
@ApiModel(description = "GoodsClassListVO")
public class GoodsClassListVO extends TreeNode implements Serializable {
...
//    private List<GoodsClassListVO> goodsClassListVOS;
